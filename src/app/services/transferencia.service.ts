...
export class TransferenciaService {
  urlTransferencias = 'https://desafio-ripley-server.herokuapp.com/api/transferencias';

  urlDestinatarios = 'https://desafio-ripley-server.herokuapp.com/api/destinatarios/';
